...
NDefines.NMilitary.REGIMENTAL_SUPPORT_REQUIRED_BATTALIONS = { 3 } -- VANILLA 3 -- For each regimental support row, how many battalions are required in the regiment to be able to place a support in that row.
